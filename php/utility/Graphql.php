...
// ShameAsAService SDK utility: graphql
//
...
class ShameAsAServiceGraphql
{
    ...
    // equivalent.
    public static function body(ShameAsAServiceContext $ctx): mixed
    {
    ...
    public static function errors(ShameAsAServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
