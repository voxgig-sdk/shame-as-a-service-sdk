...
// ShameAsAService SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ShameAsAServiceMakeRequest
{
    public static function call(ShameAsAServiceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ShameAsAServiceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ShameAsAServiceResponse($fetched);
        } else {
