...
// ShameAsAService SDK utility: make_options

class ShameAsAServiceMakeOptions
{
    ...
    public static function call(ShameAsAServiceContext $ctx): array
    {
        ...
        //
        // `ShameAsAServiceSchema::optspec()` is built from the model:
        ...
        $optspec = ShameAsAServiceSchema::optspec();
