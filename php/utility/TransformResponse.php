...
// ShameAsAService SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ShameAsAServiceTransformResponse
{
    public static function call(ShameAsAServiceContext $ctx): mixed
    {
        ...
        $transform = ShameAsAServiceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
