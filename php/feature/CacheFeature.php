...
// ShameAsAService SDK cache feature
...
class ShameAsAServiceCacheFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _through(ShameAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
