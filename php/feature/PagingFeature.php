...
// ShameAsAService SDK paging feature
...
class ShameAsAServicePagingFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _is_list(ShameAsAServiceContext $ctx): bool
    {
