...
// ShameAsAService SDK audit feature
...
class ShameAsAServiceAuditFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _emit(ShameAsAServiceContext $ctx, string $outcome): void
    {
