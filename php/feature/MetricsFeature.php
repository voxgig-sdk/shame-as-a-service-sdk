...
// ShameAsAService SDK metrics feature
...
class ShameAsAServiceMetricsFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _record(ShameAsAServiceContext $ctx, bool $ok): void
    {
