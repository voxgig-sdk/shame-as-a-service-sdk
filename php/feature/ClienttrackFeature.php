...
// ShameAsAService SDK clienttrack feature
...
class ShameAsAServiceClienttrackFeature extends ShameAsAServiceBaseFeature
{
    ...
    public function PostConstruct(ShameAsAServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ShameAsAService-SDK';
