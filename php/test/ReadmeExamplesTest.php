...
// ShameAsAService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ShameAsAServiceSDK::test)
...
{
    private const SDK_CLASS = 'ShameAsAServiceSDK';
    ...
    private const SDK_BASE = 'shameasaservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../shameasaservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
