...
class GetShameMessageDirectTest extends TestCase
{
    public function test_direct_load_get_shame_message(): void
    {
        $setup = get_shame_message_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_shame_message", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
