...
The PHP SDK for the ShameAsAService API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetShameMessage(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->ShameAsAService(null)->load(
    ["id" => "test01"], null
);
