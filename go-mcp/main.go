// Command ShameAsAService-mcp is an MCP server exposing the ShameAsAService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ShameAsAService_list  — list records of an entity
//	ShameAsAService_load  — load a single record of an entity
//
