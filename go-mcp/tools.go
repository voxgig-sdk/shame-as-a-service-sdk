...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_shame_message"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ShameAsAServiceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "shame-as-a-service_list",
		Description: "List records from ShameAsAService. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "shame-as-a-service_load",
		Description: "Load a single record from ShameAsAService. " +
...
func runOp(client *sdk.ShameAsAServiceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ShameAsAServiceSDK, name string) (sdk.ShameAsAServiceEntity, error) {
	switch strings.ToLower(name) {
	case "get_shame_message":
		return client.GetShameMessage(nil), nil
