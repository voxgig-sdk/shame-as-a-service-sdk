...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/shame-as-a-service` | `npm install @voxgig-sdk/shame-as-a-service` |
| Python | `voxgig-sdk-shame-as-a-service` | `pip install voxgig-sdk-shame-as-a-service` |
| PHP | `voxgig-sdk/shame-as-a-service` | `composer require voxgig-sdk/shame-as-a-service` |
| Golang | `github.com/voxgig-sdk/shame-as-a-service-sdk/go` | `go get github.com/voxgig-sdk/shame-as-a-service-sdk/go` |
| Ruby | `voxgig-sdk-shame-as-a-service` | `gem install voxgig-sdk-shame-as-a-service` |
| Lua | `voxgig-sdk-shame-as-a-service` | `luarocks install voxgig-sdk-shame-as-a-service` |
