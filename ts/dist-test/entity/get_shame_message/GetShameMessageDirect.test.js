...
(0, node_test_1.describe)('GetShameMessageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ShameAsAServiceSDK({
    ...
    (0, node_test_1.test)('direct-load-get_shame_message', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_shame_message', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SHAME_AS_A_SERVICE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ShameAsAServiceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SHAME_AS_A_SERVICE_TEST_GET_SHAME_MESSAGE_ENTID'];
    ...
    const client = new __1.ShameAsAServiceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetShameMessageDirect.test.js.map