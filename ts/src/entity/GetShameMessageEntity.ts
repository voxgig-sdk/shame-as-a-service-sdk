...
class GetShameMessageEntity extends ShameAsAServiceEntityBase<GetShameMessage> {
  ...
  make(this: GetShameMessageEntity) {
    return new GetShameMessageEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GetShameMessageLoadMatch, ctrl?: Control): Promise<GetShameMessageEntity> {
