...
local GetShameMessageEntity = {}
GetShameMessageEntity.__index = GetShameMessageEntity


function GetShameMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetShameMessageEntity)
  self._name = "get_shame_message"
  self._client = client
...
function GetShameMessageEntity:get_name()
  return self._name
end


function GetShameMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetShameMessageEntity.new(self._client, opts)
end
...
function GetShameMessageEntity:mark_deleted()
  self._deleted = true
end


function GetShameMessageEntity:deleted()
  return true == self._deleted
end


function GetShameMessageEntity:data_set(args)
  if args ~= nil then
...
function GetShameMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetShameMessageEntity:match_set(args)
  if args ~= nil then
...
function GetShameMessageEntity:match_get()
...
function GetShameMessageEntity:stream(action, args, callopts)
...
function GetShameMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
