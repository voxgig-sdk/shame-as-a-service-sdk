...
function runner.env_override(m)
  local live = runner.getenv("SHAMEASASERVICE_TEST_LIVE")
  local override = runner.getenv("SHAMEASASERVICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SHAMEASASERVICE_TEST_EXPLAIN")
