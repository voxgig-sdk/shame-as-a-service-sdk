...
function runner.env_override(m)
  local live = runner.getenv("SHAME_AS_A_SERVICE_TEST_LIVE")
  local override = runner.getenv("SHAME_AS_A_SERVICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SHAME_AS_A_SERVICE_TEST_EXPLAIN")
