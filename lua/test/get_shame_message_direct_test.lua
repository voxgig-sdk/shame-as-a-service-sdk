...
describe("GetShameMessageDirect", function()
  it("should direct-load-get_shame_message", function()
    local setup = get_shame_message_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_shame_message", setup.live and "live" or "unit")
...
function get_shame_message_direct_setup(mockres)
