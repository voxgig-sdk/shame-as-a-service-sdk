// Command ShameAsAService-cli is a CLI + REPL for the ShameAsAService SDK,
...
const prompt = "shame-as-a-service"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "get_shame_message"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      SHAME_AS_A_SERVICE_APIKEY (api key), SHAME_AS_A_SERVICE_BASE (base url override)")
