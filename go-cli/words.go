...
func registerSDKWords(r *eng.Registry, client *sdk.ShameAsAServiceSDK) {
...
func runOp(client *sdk.ShameAsAServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
