...
AQL-driven CLI and REPL for the ShameAsAService SDK. Positional arguments are
...
```sh
go build -o shame-as-a-service-cli ./...
```
...
./shame-as-a-service-cli list get_shame_message
./shame-as-a-service-cli load 1 get_shame_message
./shame-as-a-service-cli load '{id:1}' get_shame_message
