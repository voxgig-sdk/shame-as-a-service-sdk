...
class ShameAsAServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShameAsAServiceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ShameAsAServiceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ShameAsAServiceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
