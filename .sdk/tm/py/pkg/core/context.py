...
from projectname_sdk.core.control import ShameAsAServiceControl
...
class ShameAsAServiceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ShameAsAServiceControl()
        ...
        if isinstance(sp, ShameAsAServiceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ShameAsAServiceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ShameAsAServiceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ShameAsAServiceOperation({})
    ...
    def make_error(self, code, msg):
        return ShameAsAServiceError(code, msg, self)
