...
local function make_error_util(ctx, err)
  ...
  local msg = "ShameAsAServiceSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = ShameAsAServiceError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == ShameAsAServiceError then
