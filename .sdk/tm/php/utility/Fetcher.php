...
// ShameAsAService SDK utility: fetcher

class ShameAsAServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ShameAsAServiceSDK/1.0)';
    ...
    public static function call(ShameAsAServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
