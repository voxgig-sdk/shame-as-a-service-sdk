...
// ShameAsAService SDK utility: result_basic

class ShameAsAServiceResultBasic
{
    public static function call(ShameAsAServiceContext $ctx): ?ShameAsAServiceResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ShameAsAServiceError) ? $result->err->msg : (string)$result->err;
