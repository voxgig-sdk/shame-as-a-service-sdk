...
// ShameAsAService SDK utility type

class ShameAsAServiceUtility
{
    ...
    public static function copy(ShameAsAServiceUtility $src): ShameAsAServiceUtility
    {
        $u = new ShameAsAServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
