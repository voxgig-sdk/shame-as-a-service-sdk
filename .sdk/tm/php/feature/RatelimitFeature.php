...
// ShameAsAService SDK ratelimit feature
...
class ShameAsAServiceRatelimitFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _acquire(ShameAsAServiceContext $ctx): void
    {
    ...
    private function _track(ShameAsAServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
