...
// ShameAsAService SDK telemetry feature
...
class ShameAsAServiceTelemetryFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _close(ShameAsAServiceContext $ctx, bool $ok): void
    {
