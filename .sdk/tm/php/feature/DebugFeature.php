...
// ShameAsAService SDK debug feature
...
class ShameAsAServiceDebugFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _finish(ShameAsAServiceContext $ctx, bool $ok): void
    {
