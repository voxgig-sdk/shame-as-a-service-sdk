...
// ShameAsAService SDK rbac feature
...
class ShameAsAServiceRbacFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _required(ShameAsAServiceContext $ctx): ?string
    {
    ...
    private function _reject(ShameAsAServiceContext $ctx, string $required): void
    {
    ...
    private function _track(ShameAsAServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
