...
// ShameAsAService SDK proxy feature
...
class ShameAsAServiceProxyFeature extends ShameAsAServiceBaseFeature
{
    ...
    public function init(ShameAsAServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ShameAsAServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
