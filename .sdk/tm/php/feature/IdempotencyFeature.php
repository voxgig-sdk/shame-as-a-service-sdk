...
// ShameAsAService SDK idempotency feature
...
class ShameAsAServiceIdempotencyFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _mutating(ShameAsAServiceContext $ctx): bool
    {
