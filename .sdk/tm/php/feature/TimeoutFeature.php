...
// ShameAsAService SDK timeout feature
...
class ShameAsAServiceTimeoutFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _with_timeout(ShameAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ShameAsAServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
