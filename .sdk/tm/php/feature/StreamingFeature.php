...
// ShameAsAService SDK streaming feature
...
class ShameAsAServiceStreamingFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _iterate(ShameAsAServiceResult $result): \Generator
    {
    ...
    private function _streamable(ShameAsAServiceContext $ctx): bool
    {
