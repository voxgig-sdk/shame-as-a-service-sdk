...
// ShameAsAService SDK netsim feature
...
class ShameAsAServiceNetsimFeature extends ShameAsAServiceBaseFeature
{
    ...
    private function _simulate(ShameAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ShameAsAServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
