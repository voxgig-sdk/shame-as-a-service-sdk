...
// ShameAsAService SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ShameAsAServiceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ShameAsAServiceOmni::structfix($now, Struct::undef()))
                        !== json_encode(ShameAsAServiceOmni::structfix($val, Struct::undef()))) {
