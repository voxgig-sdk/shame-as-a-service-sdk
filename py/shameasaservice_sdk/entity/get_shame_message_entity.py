...
from shameasaservice_sdk.shameasaservice_types import (
    GetShameMessage,
...
class GetShameMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetShameMessageEntity(self._client, opts)
    ...
    def data_get(self) -> GetShameMessage:
    ...
    def match_get(self) -> GetShameMessage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetShameMessage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetShameMessage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
