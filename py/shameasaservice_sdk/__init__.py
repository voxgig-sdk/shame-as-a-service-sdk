...
from shameasaservice_sdk.utility import register

# Load features
from shameasaservice_sdk.feature.base_feature import ShameAsAServiceBaseFeature
from shameasaservice_sdk.features import _has_feature, _make_feature
...
class ShameAsAServiceSDK:
    ...
    def get_utility(self):
        return ShameAsAServiceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ShameAsAServiceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetShameMessage(self, data=None) -> "GetShameMessageEntity":
        ...
        from shameasaservice_sdk.entity.get_shame_message_entity import GetShameMessageEntity
