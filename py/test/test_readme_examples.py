# ShameAsAService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ShameAsAServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ShameAsAServiceSDK(...) and ShameAsAServiceSDK.test(...) become
#      ShameAsAServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "shameasaservice_sdk"
_SDK_CLASS = "ShameAsAServiceSDK"
...
_ENTITIES = {
    "GetShameMessage": "get_shame_message",
}
