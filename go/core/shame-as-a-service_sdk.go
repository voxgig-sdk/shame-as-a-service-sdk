...
type ShameAsAServiceSDK struct {
	Mode     string
...
func (sdk *ShameAsAServiceSDK) OptionsMap() map[string]any {
...
func (sdk *ShameAsAServiceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ShameAsAServiceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ShameAsAServiceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ShameAsAServiceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ShameAsAServiceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ShameAsAServiceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ShameAsAServiceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ShameAsAServiceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ShameAsAServiceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ShameAsAServiceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ShameAsAServiceSDK {
	...
	sdk := NewShameAsAServiceSDK(sdkopts)
	sdk.Mode = "test"
