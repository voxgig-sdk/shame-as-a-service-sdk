...
#      offline in seeded test mode (ShameAsAServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ShameAsAService_sdk.rb")
  SDK_CLASS = "ShameAsAServiceSDK"
